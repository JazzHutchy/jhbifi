...
Listing.create!(title: 'Brand New Vaccuum Cleaner', description: 'I have a new Dyson Vaccuum which I never opened up and I would like to upgrade to a newer model that I just discovered. I want to sell this cleaner for ideally $100, though the price is negotiatable.', price: 100, list_date: "2017-10-4", user_id: 1)
...
Review.create!(rating: 9, content: "Top bloke, great seller", user_id: 2)
Review.create!(rating: 3, content: "This guy is a knob, don't buy from him!", user_id: 3)
Review.create!(rating: 5, content: "Has trouble paying on time but he gets the job done", user_id: 1)